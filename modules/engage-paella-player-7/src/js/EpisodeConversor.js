...
function processAttachments(episode, manifest, config) {
  ...
  // Ensure frameList is defined, even when there are no navigation segment preview slides
  // Ref: https://github.com/polimediaupv/paella-core/issues/343
  manifest.frameList = navigationPreviewImages || [];
